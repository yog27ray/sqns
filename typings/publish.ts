...
export interface UpdateMessageByDeduplicationId { QueueUrl: string; MessageDeduplicationId: string; DelaySeconds?: number; ReceiveCount?: number; State?: EventState; }
