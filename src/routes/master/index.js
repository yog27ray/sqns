...
function generateRoutes(eventManager) {
    ...
    router.post('/queue/:queueName/event/:id/success', (req, res) => controller.eventSuccess(req, res));
    router.post('/queue/:queueName/event/:id/failure', (req, res) => controller.eventFailure(req, res));
